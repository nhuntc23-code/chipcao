...
public class ResidentRepository {
    ...
    public void save(Resident r) {
        String sql = "INSERT INTO Resident (HouseholdID, FullName, DateOfBirth, Gender,Relationship) VALUES( ?,  ?,  ?,  ?,  ?)";
    ...
    public void update(Resident r) {
        String sql = "UPDATE Resident SET HouseholdID=?, FullName=?, DateOfBirth=?,Gender =  ?, Relationship =  ? WHERE  ResidentID =  ?";
        jdbcTemplate.update(sql, r.getHouseholdID(), r.getFullName(), r.getDateOfBirth(),
